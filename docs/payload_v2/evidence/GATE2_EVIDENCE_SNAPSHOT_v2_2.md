...
- Gate 2B (Execution Determinism, executor_v2 static summon + replay_v2): PASS
- Real summon replay_v2 coverage: INCLUDED (static summon baseline)
- Overall Gate 2 status: PASS

## Environment Anchors
- commit_hash: `54ee783520c301c4626f0b72fc517ee5ca5ff4b1`
- rule_version: `rule_v2_2`
- engine_version: `engine_v2_1`
- schema_version (execution path used in Gate 2B): `plugin_payload_v2`

## Evidence Artifacts

| Artifact | SHA256 | Bytes |
|---|---|---:|
| `docs/payload_v2/evidence/gate2_replay_report.json` | `41e242ab2d82b58a4f1002df5d355c4e8644be533eae547125848cf29e340d16` | 2536 |
| `docs/payload_v2/evidence/gate2b_execution_replay_report.json` | `a5128927bc4fb189e95b60b51fe1d8e80b51902af6298143186ab3316a2e9284` | 3847 |
| `docs/payload_v2/evidence/gate2_artifact_manifest.json` | *(container manifest for this snapshot)* | *(generated)* |
...
| `tools/gate2b_execution_replay_check.py` | `dad2507d46b127747a225b294780e6ee9eb58f3b20c2f62068e09270019ff6cb` | 5792 |
...
## Audit Notes
- This snapshot certifies determinism for current projection and static summon baseline execution path.
- It covers replay determinism for real static summon (`villager`, `NoAI=true`, `Silent=true`, fixed rotation/offset) under executor_v2/replay_v2.
